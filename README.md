# Movies and Alcohol in Tamil Nadu: Data-Analysis Project
...
3. Clean datasets
4. Join datasets using primary key as year
5. Form visualizations to understand effect
...
<br><b>RESULT:</b><br>We can conclude that in the past ten year when the top Tamil movies have a surge in displaying alcohol and substances content, the purchasing of alcohol (in turn the consumption) is reduce.<br><br>We notice this in 2016 when there is an all time low in revenue of alcohol and an all time high in displaying alcohol in Tamil movies. Similarly, we note the opposite effect in 2020.
